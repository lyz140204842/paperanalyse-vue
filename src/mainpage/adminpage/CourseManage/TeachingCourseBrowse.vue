<template>
  ...
  <el-card>
    ...
    <template>
      <el-table stripe border :header-cell-style="{background:'#409EFF',color:'#FFFFFF'}" :data="teachingCourses" ref="filterTable" style="font-size: medium;font-family: 楷体;" border>
